...
<head>
    ...
    <meta name="description" content="Escribir nueva publicacion">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Ingresar</strong> nueva publicación:
                                    </div>
                                        ...
                                        <form id="publishForm" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" required id="text-input" name="titulo" placeholder="Titulo"class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="email-input" required name="desc_c" placeholder="Descripción..." class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="cuerpo" required id="textarea-input" rows="9" placeholder="Contenido..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="file-input" class=" form-control-label">Imágen:</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="file" required id="file-input" name="file-input" class="form-control-file">
                                                </div>
                                            </div>
                                            <input type="hidden">
